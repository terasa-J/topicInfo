...
function _jsq_(treeid, pagename, newsid, owner)
{
    ...
    var r = '&e=1&w='+screen.width + '&h='+ screen.height+'&treeid='+treeid+'&color='+c+'&pageurl='+e.encode(document.location.href)+'&refer='+e.encode(document.referrer)+ '&pagename='+e.encode(pagename)+'&newsid='+newsid;
